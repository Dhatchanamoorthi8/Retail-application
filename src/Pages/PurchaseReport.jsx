...
function PurchaseReport() {
  ...
  const SearchData = () => {
    console.log(getData);
    axios.get(`${apiUrl}/purchasesalesreport`, {
      params: getData
    })
      .then((res) => {
  ...
  const headers = [
    ...
    { label: "Purchage Quantity", key: "purchageqty" },
    { label: "Sales Quantity", key: "SalesQty" },
    { label: "Balance Quantity", key: "BalanceQty" },
  ];
  ...
  return (
    ...
    <div className="log-report">
      ...
      <div className="print-button d-flex align-items-center justify-content-between   mt-4">
        <div className="document d-flex gap-3 ms-auto ">
      ...
      <div className="heading mt-3">
        <h1 className='text-4xl fw-semibold text-center mb-2'>Purchase Sales Report</h1>
        <hr />
      </div>
          ...
          <table className="w-full table-hover">
            <thead className="bg-gray-50 border-b-2 border-gray-200">
              <tr>
                ...
                <th className="p-3 text-sm font-semibold tracking-wide text-center">SupplierName</th>
                <th className="p-3 text-sm font-semibold tracking-wide text-center">Product Name</th>
                <th className="p-3 text-sm font-semibold tracking-wide text-center">Purchase Quantity</th>
                <th className="p-3 text-sm font-semibold tracking-wide text-center">Balance Quantity</th>
                <th className="p-3 text-sm font-semibold tracking-wide text-center">Sales Quantity</th>
              </tr>
            </thead>
