...
const Sidebar = ({ children, onLogout, }) => {
    ...
    useEffect(() => {
        ...
        if (storedUserData && storedUserData.username && storedUserData.description && storedUserData.password && storedUserData.usercode) {
            ...
            console.log(storedUserData,'setSessiondatas');
        } else {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subItems: [
                { name: 'Purchase sales Report', path: '/purchasesalesreport', icon: <MdArrowRight style={{ fontSize: "30px" }} /> },
                { name: 'Customer Sales Report', path: '/customerwisesalesreport', icon: <MdArrowRight style={{ fontSize: "30px" }} /> },
            ],
        },
        {
            name: 'Profile',
    ...
    const handlechangepassword = () => {
        ...
        if (sessiondatas.password !== oldpassword) {
            Swal.fire({
            ...
            <Modal show={show} animation={true} onHide={modalClose}>
                ...
                <Modal.Body>
                    ...
                    <div className="changepassword-btn col-12 mt-3">
                        <button tabIndex={true} type='button' className='btn btn-outline-primary col-12' onClick={handlechangepassword}>Change Password</button>
                    </div>
                </Modal.Body>
            </Modal>
            <ToastContainer/>
